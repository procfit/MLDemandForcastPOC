...
- [ ] **F15 — Avaliação da execução e questionário do comprador**: o dado de campo do TCC. **São duas coisas diferentes**, e o desenho mudou em 19/09/2026 por orientação do Professor, registrada pelo patrocinador no documento de 16/09.
  ...
  - **A versão do instrumento saiu do código e da UI.** "V3"/"V5"/"V6" é controle do documento de quem conduz a pesquisa; o usuário final não vê versão em lugar nenhum, e `VersaoCatalogo` é carimbo silencioso sem leitor. O que mantém a resposta legível é o retrato do enunciado gravado com ela. Contrato em [CLAUDE.md §4](CLAUDE.md).
