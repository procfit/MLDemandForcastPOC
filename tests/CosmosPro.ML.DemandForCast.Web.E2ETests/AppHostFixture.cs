...
public sealed class AppHostFixture : IAsyncLifetime
{
        ...
        CancellationToken ct = default)
    {
        ...
        foreach (var item in itens)
        {
            ...
            insertItem.CommandText = """
                INSERT INTO dbo.ComparacaoSessaoItens
                    (SessaoId, LojaId, Sku, NomeProduto, Curva, CompraSugeridaPbs, CompraSugeridaMl,
                     ...
                     MercadoValorRede, MercadoValorConcorrentes, PrecoVendaPraticado)
                VALUES
                    (@sessaoId, @lojaId, @sku, @nomeProduto, @curva, @compraPbs, @compraMl,
                     ...
                     @fabricante, @ean, @estoqueNaSugestao, @estoqueNoFim, @vendaMedia, @mercadoValorRede, @mercadoValorConc, @precoPraticado);
                """;
            ...
            insertItem.Parameters.AddWithValue("@precoPraticado", (object?)item.PrecoVendaPraticado ?? DBNull.Value);
